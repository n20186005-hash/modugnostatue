 ...
 */
export default async function BlogPostDomenicoModugno({
  params,
}: {
  ...
  const isChinese = locale === 'zh' || locale === 'zh-Hant'; // Default fallback
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <article className="lg:w-2/3 w-full">
            ...
            <div className="mt-8 text-center sm:text-left">
              <a href={`/${locale}/blog`} className="inline-flex items-center gap-2 text-[#1e3a54] dark:text-slate-300 hover:text-[#f0b429] font-medium transition-colors">
